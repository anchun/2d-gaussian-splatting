...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 image_name, uid,
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, gt_semantic=None, data_device = "cuda"
                 ):
        ...
        self.gt_semantic = gt_semantic.to(self.data_device) if gt_semantic is not None else None
